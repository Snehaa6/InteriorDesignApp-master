			...
			for (FileItem item1 : multiparts) {
				if (item1.isFormField()) {
					...
					if (item1.getFieldName().equals("bname"))
						{
						if(item1.getString().equals("Wood"))
							bid = 1;
						if(item1.getString().equals("Stone"))
							bid = 2;
						if(item1.getString().equals("Plastic"))
							bid = 3;
						if(item1.getString().equals("Polyester"))
							bid = 4;
						if(item1.getString().equals("Fiberglass"))
							bid = 5;
						if(item1.getString().equals("Plywood"))
							bid = 6;
						if(item1.getString().equals("Laminate"))
							bid = 7;
						}
					if (item1.getFieldName().equals("cname"))
					{
						if(item1.getString().equals("Bedroom"))
							cid = 1;
						if(item1.getString().equals("Kitchen"))
							cid = 2;
						if(item1.getString().equals("Hall"))
							cid = 3;
						if(item1.getString().equals("Bathroom"))
							cid = 4;
					}
